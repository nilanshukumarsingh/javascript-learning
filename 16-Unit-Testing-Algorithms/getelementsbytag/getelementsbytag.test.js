...
describe('Get Elements By Tag', () => {
    ...
    // No root is passed it return an empty array
    ...
    it('should return only the root element if no tagName is passed in', () => {
        const root = document.createElement('div');  // Creating mock element this "document" wont be available here because JSDom environment if it wasnt here it would give here error because it is node js not html
